...
class MainActivity : AppCompatActivity() {
    ...
    private fun openCamera() {
        ...
        val camertaIntent = Intent(MediaStore.ACTION_IMAGE_CAPTURE)
        camertaIntent.putExtra(MediaStore.EXTRA_OUTPUT, image_uri)

        startActivityForResult(camertaIntent, OPEN_CAMERA_CODE)
    }
